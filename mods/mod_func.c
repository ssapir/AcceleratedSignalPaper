...
extern void _Ih_reg();
extern void _Ih_human_reg();
extern void _Ih_human_shifts_reg();
extern void _Ih_human_shifts2_reg();
extern void _Ih_human_shifts3_reg();
extern void _Ih_human_shifts_freeze_reg();
extern void _Ih_human_shifts_mul_add_reg();
extern void _Ih_human_shifts_mul_add_uni_reg();
extern void _Im_reg();
...
fprintf(stderr," Ih_human.mod");
fprintf(stderr," Ih_human_shifts.mod");
fprintf(stderr," Ih_human_shifts2.mod");
fprintf(stderr," Ih_human_shifts3.mod");
fprintf(stderr," Ih_human_shifts_freeze.mod");
fprintf(stderr," Ih_human_shifts_mul_add.mod");
fprintf(stderr," Ih_human_shifts_mul_add_uni.mod");
